...
$fetch_jobs = "select * from hire_db where username = '$name'";
                   ...
                   <table class="table table-striped table-dark table-hover">
                       ...
                       <tbody>
                           ...
                           <tr>
                               ...
                               <td><button class="disabled btn btn-success">Hired</button>
                            <br>
                            <font><small style="color: white;">Check Your Mail</small></font>
                            </td>
                           </tr>
                           <?php
                           }
